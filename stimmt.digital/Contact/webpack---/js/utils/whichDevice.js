...
function getMobileState() {
    ...
    var ua = userAgent; // Facebook mobile app's integrated browser adds a bunch of strings that
    ...
    var isMobileInstance = new _isMobile.default.Class(ua);
...
function isAnyMobile() {
    var mobileState = getMobileState(); // any includes things that are not included in phone ie 7 inch and 'other'
